    ...
    return (
        <div>
            ...
            <Modal show={showUpdate} onHide={closeUpdateModal}>
                ...
                <Form onSubmit={handleUpdate}>
                    <Modal.Body>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control type="text" placeholder="Enter Phone No" value={phoneNo} onChange={(e) => setPhoneNo(e.target.value)} required />
                        </Form.Group>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control type="text" placeholder="e.g 30/07/21" value={bookedDate} onChange={(e) => setBookedDate(e.target.value)} required />
                        </Form.Group>
                        <Form.Group>
                            <Form.Label>Time:</Form.Label>
                            <Form.Control type="text" placeholder="e.g 09:00:00" value={bookedTime} onChange={(e) => setBookedTime(e.target.value)} required />
                        </Form.Group>
             ...
             <Form.Control type="text" placeholder="Enter Clinic ID" value={clinicID} onChange={(e) => setClinicID(e.target.value)} required />
           </Form.Group> */}
                        <Form.Group>
